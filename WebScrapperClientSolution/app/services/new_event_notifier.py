    ...
    def _load_processed_events(self):
        ...
        if processed_file.exists():
            try:
                ...
                logger.warning(f"⚠️ Could not load processed events: {e}")
        ...
        try:
            ...
            <body style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <div style="margin-top: 20px; padding: 10px; background-color: #e3f2fd; border-left: 4px solid #2196F3; border-radius: 3px;">
                    <p style="margin: 0;"><strong>ℹ️ Note:</strong> This is a notification for a newly created event. You will receive separate reminders before the event starts.</p>
                </div>
            </body>
            </html>
            """
